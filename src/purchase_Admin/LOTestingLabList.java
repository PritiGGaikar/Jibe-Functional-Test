...
public class LOTestingLabList extends RW{
	...
	public synchronized static ExtentReports getReporter(String filePath) { //allow only one thread to access the shared resource,To prevent thread interference.
	 ...
	 public void TestingLabList(WebDriver driver1) throws Exception {  //(priority=0)
	    ...
	    public void NegativeTestCaseforAddNewLab(WebDriver driver1) throws Exception { //(priority=1)

		WebDriver driver = driver1;

	    ArrayList<Row> row= OR_Purchase_m.searchSheet("NegativeTestCaseforAddNewLab",2,9);//Functn key,sheetNo.,Column no.// Xpath locator
	    ArrayList<Row> row1=input_purc_m.searchSheet("NegativeTestCaseforAddNewLab", 2,0);//Functn key, sheet no, test data excel
	...
	public void AddNewLab(WebDriver driver1) throws Exception {//(priority=2)

		WebDriver driver = driver1;

	    ArrayList<Row> row= OR_Purchase_m.searchSheet("AddNewLab",2,9);//Functn key,sheetNo.,Column no.// Xpath locator
	    ArrayList<Row> row1=input_purc_m.searchSheet("AddNewLab", 2,0);//Functn key, sheet no, test data excel
