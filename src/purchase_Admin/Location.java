...
public class Location extends RW{
	...
	public void Locations(WebDriver driver1) throws Exception {  
	 ...
	 public void NegativeTestCaseAddNewLocation(WebDriver driver1) throws Exception {  

			WebDriver driver = driver1;
			
			  ArrayList<Row> row= OR_Purchase_m.searchSheet("NegativeTestCaseAddNewLocation",2,9);//Functn key,sheetNo.,Column no.// Xpath locator
			    ArrayList<Row> row1=input_purc_m.searchSheet("NegativeTestCaseAddNewLocation", 2,0);//Functn key, sheet no, test data excel
	 ...
	 public void AddNewLocation(WebDriver driver1) throws Exception { 
