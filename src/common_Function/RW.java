...
public class RW
{
	...
	public static String path="C:\\Users\\Priti\\workspace\\JibeFunctionalTest\\"; //Workspace-->Project-->excel path
	
	
	
    public ExcelRead jibe_config = new ExcelRead(path.concat("src\\Jibe_Config\\Jibe_Config.xlsx"));  // Read config data from Excel
    
    public ExcelRead OR_Purchase_m = new ExcelRead(path.concat("src\\object\\OR_Purchase_m.xlsx")); // Read Purchase element locators
    
    public ExcelRead input_purc_m = new ExcelRead(path.concat("src\\Input_Purchase\\input_purc_m.xlsx")); //Read purchase input data
...
/*	
	...
	public static String path="C:\\Users\\Priti\\workspace\\JibeFunctionalTest\\"; //Workspace excel path
